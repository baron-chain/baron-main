...
// this line is used by starport scaffolding # stargate/app/storeKey
	...
	*/
	...
	app.BaronchainKeeper = *baronchainmodulekeeper.NewKeeper(
		appCodec,
		keys[baronchainmoduletypes.StoreKey],
		keys[baronchainmoduletypes.MemStoreKey],
		app.GetSubspace(baronchainmoduletypes.ModuleName),
	)
