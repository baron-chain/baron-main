import { Client, registry, MissingWalletError } from 'baronchain-client-ts'

import { StakeAuthorization } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { StakeAuthorization_Validators } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { LastValidatorPower } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { HistoricalInfo } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { CommissionRates } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { Commission } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { Description } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { Validator } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { ValAddresses } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { DVPair } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { DVPairs } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplet } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplets } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { Delegation } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegation } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegationEntry } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntry } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { Redelegation } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { Params } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { DelegationResponse } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntryResponse } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationResponse } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { Pool } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
import { ValidatorUpdates } from "baronchain-client-ts/cosmos.staking.v1beta1/types"
